        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
                    ...
                    <MotionButton
                        {...scaleHover}
                        className="bg-white text-black hover:bg-slate-200 rounded-full font-bold px-6 h-auto py-2.5"
                    >
                        Get Started
                    </MotionButton>
                </div>
                ...
                <Sheet>
                    ...
                    <SheetContent side="top" className="bg-black border-b border-white/10 w-full p-0">
                        <div className="flex flex-col p-6 gap-6">
                            ...
                            <Button className="bg-white text-black hover:bg-slate-200 w-full py-6 text-lg font-bold rounded-xl">
                                Get Started
                            </Button>
                        </div>
                    </SheetContent>
...
const PricingCard = ({
    ...
    >
        ...
        <MotionButton
            {...scaleHover}
            className={`w-full py-6 rounded-2xl font-bold text-base transition-all h-auto ${featured ? "bg-black text-white hover:bg-black/80" : "bg-white text-black hover:bg-white/90"
                }`}
        >
            Get Started
        </MotionButton>
                ...
                <section className="relative pt-48 pb-32 px-6">
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        <motion.h1
                            ...
                            className="text-5xl md:text-[9rem] font-black tracking-tighter leading-[0.9] md:leading-[0.85] mb-8 md:mb-12 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/40"
                        >
                            SHIP FASTER <br />
                            TOGETHER.
                        </motion.h1>
